...
export const OFFLINE_CORE_FILES = [
  ...
  './media/kotoba-checkpoint/tokyo-terminal.png', './media/kotoba-checkpoint/traveller-aiko.png', './media/kotoba-checkpoint/traveller-haru.png', './media/kotoba-checkpoint/traveller-mio.png', './media/kotoba-checkpoint/traveller-ren.png', './media/kotoba-checkpoint/traveller-sora.png', './media/kotoba-checkpoint/terminal-ambience.ogg', './media/kotoba-checkpoint/stamp.wav', './media/kotoba-checkpoint/clear.mp3',
