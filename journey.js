...
(() => {
  ...
  function renderExperimentalTimeline(data, track, options = {}) {
    ...
    track.innerHTML = `<div class="experimental-journey-shell"><img class="experimental-journey-hero-art" src="media/experimental/kaishi-journey-hero.png" alt="" aria-hidden="true">
      <section class="experimental-journey-hero-copy" aria-label="Kaishi Japanese"><div><span class="experimental-hero-brand">Kaishi <em>Japanese</em> <small class="experimental-hero-version">v${APP_VERSION}</small></span><p>一歩ずつ、もっと遠くへ</p><small>A brighter you,<br>a closer Japan.</small></div><div class="experimental-hero-actions"><button type="button" class="experimental-hero-profile" data-experimental-profile-trigger aria-haspopup="dialog"><img class="experimental-journey-profile-avatar" src="media/profiles/guest-learner.webp" alt="Guest learner"><span><b class="experimental-journey-profile-name">Guest learner</b><small lang="ja">はじめよう！</small></span><strong aria-hidden="true">›</strong></button><button type="button" class="experimental-hero-japan-ready" data-experimental-japan-ready><svg class="experimental-hero-japan-icon" viewBox="0 0 48 48" aria-hidden="true"><path d="M8 17h32M12 17l3-8 3 8m12 0 3-8 3 8M16 18v21m16-21v21M10 39h28M23 17v22"/></svg><span>Japan Ready</span><strong aria-hidden="true">›</strong></button><button type="button" class="experimental-hero-settings" data-experimental-settings-trigger aria-label="Open settings">⚙</button></div></section>
      ...
      <div class="experimental-journey-heading"><span class="experimental-journey-heading-mark" aria-hidden="true">✦</span><div><h1>Your Journey</h1><p>Small steps. A bigger tomorrow.</p></div><span class="experimental-journey-heading-note">続ければ、<br>きっと届く</span></div>
