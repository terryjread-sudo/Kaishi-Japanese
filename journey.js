...
(() => {
  ...
  function renderExperimentalTimeline(data, track, options = {}) {
    ...
    track.innerHTML = `<div class="experimental-journey-shell"><img class="experimental-journey-hero-art" src="media/experimental/kaishi-journey-hero.png" alt="" aria-hidden="true">
      <section class="experimental-journey-hero-copy" aria-label="Kaishi Japanese"><div><span class="experimental-hero-brand">Kaishi <em>Japanese</em></span><p>一歩ずつ、もっと遠くへ</p><small>A brighter you,<br>a closer Japan.</small></div><div class="experimental-hero-actions"><button type="button" class="experimental-hero-profile" data-experimental-profile-trigger aria-haspopup="dialog"><img src="media/profiles/guest-learner.webp" alt="Guest learner"><span><b>Guest learner</b><small lang="ja">はじめよう！</small></span><strong aria-hidden="true">›</strong></button><button type="button" class="experimental-hero-japan-ready" data-experimental-japan-ready><span aria-hidden="true">⛩</span><b>Japan Ready</b><strong aria-hidden="true">›</strong></button></div></section>
