...
async function init(){
 ...
 const versionCard=$('.version-card');if(versionCard){versionCard.querySelector('strong').textContent=`Kaishi Quest v${APP_VERSION}`;versionCard.querySelector('span').textContent='Focused Bonsai Progress';versionCard.querySelector('small').textContent='Growth now reflects learning breadth and mastery, with priority actions and a compact condition hint.'}
