...
async function init(){
 ...
 const versionCard=$('.version-card');if(versionCard){versionCard.querySelector('strong').textContent=`Kaishi Quest v${APP_VERSION}`;versionCard.querySelector('span').textContent='Living Bonsai Rhythm';versionCard.querySelector('small').textContent='Permanent growth now pairs with streak-responsive Resting, Steady, Flourishing and Radiant conditions.'}
