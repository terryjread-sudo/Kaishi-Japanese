...
async function init(){
 ...
 const versionCard=$('.version-card');if(versionCard){versionCard.querySelector('strong').textContent='Kaishi Quest v6.4';versionCard.querySelector('span').textContent='Daily Journey Missions';versionCard.querySelector('small').textContent='Follow an adaptive three-step route, see a mission summary, and invite friends to join your Japanese journey.'}
