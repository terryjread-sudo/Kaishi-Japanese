...
function theatreMouthStyle(character){const mouth=character.mouth||{},x=Number(mouth.x||50),y=Number(mouth.y||55),width=Number(mouth.width||10),skin=mouth.skin||'#e5a071';return `--mouth-x:${x}%;--mouth-y:${y}%;--mouth-width:${width}%;--mouth-skin:${esc(skin)}`}
