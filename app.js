...
function kotobaEchoWords(){return vocab.filter(word=>wordIntroduced(word)&&word.wordAudio&&(isAdminTestMode()||window.KaishiLearning?.wordState?.(word)!=='New'))}
