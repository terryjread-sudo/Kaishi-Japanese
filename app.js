...
function preloadTheatreAssets(scene){[...Object.values(scene.shots||{}),...scene.characters.flatMap(character=>[character.image,character.talkImage]).filter(Boolean)].forEach(path=>preloadImageUrl(theatreAsset(path)))}
